...
{
  "$end", "error", "$undefined", "TINTEGER", "TPLUS", "TMINUS", "TMUL",
  "TDIV", "$accept", "program", "statements", "statement", "numeric",
  "expression", "arithmetic", YY_NULLPTR
};
#endif
